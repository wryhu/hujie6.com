	...
	$.snowfall = function(element, options){
		var	defaults = {
			...
			function Flake(_x, _y, _size, _speed, _id)
			{
				...
				var imagePath = options.image + Math.floor(Math.random()*6) + '.png';
				var flakeMarkup = "<img class=" + 'snowfall-flakes' + " src='"+ imagePath +"' id='flake-" + this.id;
	    ...
	    // 静止
        this.stop = function(){
                        $(element).children('.snowfall-flakes').stop();
                        clearTimeout(snowTimeout);
                    };
        // 继续
        this.jixu = function(){
